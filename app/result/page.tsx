    ...
    <main className="min-h-screen bg-[#FAF8F5] relative overflow-hidden flex flex-col items-center py-20 px-6 selection:bg-dusty-rose/20">
      ...
      <div className="relative z-10 w-full max-w-5xl">
        ...
        <div className="text-center mb-24">
          ...
          <h1 className="text-7xl md:text-[10rem] font-playfair text-[#2D2926] leading-[0.85] tracking-tighter mb-10">
            {result.name}
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-4 space-y-12">
            <div className="bg-white/40 p-10 rounded-[2.5rem] border border-warm-beige/30 backdrop-blur-md">
              <h3 className="text-[10px] tracking-[0.4em] uppercase text-gray-400 mb-8">Essential Palette</h3>
              <div className="flex flex-col gap-5">
                {result.colors.map((c, i) => (
                  <div key={i} className="flex items-center gap-4 group">
                    <div className="w-12 h-12 rounded-full shadow-sm transition-transform group-hover:scale-110" style={{ backgroundColor: c.hex }} />
                    <div className="flex flex-col">
                      <span className="text-[10px] font-sans tracking-[0.2em] text-[#2D2926] uppercase font-bold">
                        {c.name}
                      </span>
            ...
            <div className="bg-white/40 p-10 rounded-[2.5rem] border border-warm-beige/30">
              <span className="text-[10px] tracking-[0.4em] uppercase text-gray-400 mb-6 block">Soul Fragrance</span>
              <p className="text-lg font-sans leading-relaxed text-[#2D2926] italic">
          ...
          <div className="lg:col-span-8 space-y-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white/40 p-10 rounded-[2.5rem] border border-warm-beige/30">
                ...
                <p className="text-sm font-sans text-gray-400 italic">{result.spaceVibe}</p>
              </div>
              <div className="bg-white/40 p-10 rounded-[2.5rem] border border-warm-beige/30">
            ...
            <div className="bg-[#2D2926] text-[#FAF8F5] p-12 rounded-[3rem] shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-8">
                  <div>
                    <h4 className="text-xs tracking-widest uppercase mb-3 text-dusty-rose font-medium">Fashion</h4>
                    <p className="text-xl font-sans leading-relaxed opacity-90">{result.fashionGuide}</p>
                  </div>
                  <div className="pt-8 border-t border-white/10">
                    <h4 className="text-xs tracking-widest uppercase mb-3 text-dusty-rose font-medium">Makeup</h4>
                    <p className="text-xl font-sans leading-relaxed opacity-90">{result.makeupGuide}</p>
                  </div>
                </div>
              </div>
            </div>
